...
list_n = input('Введите элементы списка через пробел: ').split() #указываются элементы из которых будет состоять список
...
a = list(map(int, list_n))
b = int (input('Введите число b: '))# заданное число, "ближайший по разнице элемент к которому необходимо вывести"
m = min(a, key=lambda x: abs(x-b))  #вычисляем элемент с минимальной разницей к числу "b"
# подсказку взял с форума stackoverflow.com
print(m)
